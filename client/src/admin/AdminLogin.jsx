...
export default function AdminLogin() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center p-6 bg-zinc-100 dark:bg-dark-950">
      <div className="w-full max-w-md bg-white dark:bg-dark-900 border border-zinc-200 dark:border-dark-800 rounded-2xl p-8 shadow-xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <p className="text-xs text-red-500 min-h-4 text-center">{serverError}</p>
